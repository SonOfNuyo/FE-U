...
public class Mountain : Tile {
	...
	private static Vector2 OGDefense = new Vector2 (3f, 0f);
	private static Vector2 OGResistance = new Vector2 (3f, 0f);
	private static Vector2 OGAvoid = new Vector2 (30f, 0f);
	private static Vector2 OGMove = new Vector2 (5f, 1f);
