...
public class Plains : Tile {
	...
	private static Vector2 OGDefense = new Vector2 (0f, 0f);
	private static Vector2 OGResistance = new Vector2 (0f, 0f);
	private static Vector2 OGAvoid = new Vector2 (0f, 0f);
	private static Vector2 OGMove = new Vector2 (1f, 1f);
